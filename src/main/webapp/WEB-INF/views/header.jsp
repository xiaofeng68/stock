...
<div id="headerDiv">
	<table style="width:100%;height:100%;table-layout:fixed;">
		<tr>
			<td width="180px">
				<%-- <a href="${ctx}/main"> --%>
					<img src="${ctx}/resources/images/header.png"></img>
				<!-- </a> -->
			</td>
			<td align="center">
				
			</td>
			<td width="500px" align="right" style="padding-right:5px;" class="loginInfo">
				<div>
				...
				<div style="margin-top: 15px;">上次登录时间: <fmt:formatDate value="${user.lastLoginTime }" type="both" pattern="yyyy-MM-dd HH:mm:ss"/></div>
			</td>
		</tr>
	</table>
</div>
