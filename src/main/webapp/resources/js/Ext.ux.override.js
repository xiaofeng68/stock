...
Ext.override(Ext.form.RadioGroup, {
			initComponent : Ext.form.RadioGroup.prototype.initComponent
					.createInterceptor(function() {
								if (this.allowBlank === false
										&& this.fieldLabel) {
									this.fieldLabel = '<font color=red>*</font>'
...
Ext.override(Ext.form.CheckboxGroup, {
			initComponent : Ext.form.CheckboxGroup.prototype.initComponent
					.createInterceptor(function() {
								if (this.allowBlank === false
										&& this.fieldLabel) {
									this.fieldLabel = '<font color=red>*</font>'
...
Ext.override(Ext.form.TextField, {
	...
	getErrors : function(value) {
		...
		if (valueLength < this.minLength) {
			errors.push(String.format(this.minLengthText + ',实际输入长度 '
							+ valueLength, this.minLength));
		}
		if (valueLength > this.maxLength) {
			errors.push(String.format(this.maxLengthText + ',实际输入长度 '
...
/**覆盖GridPanel的afterRender方法让celltip其作用--cellTip:true,**/
